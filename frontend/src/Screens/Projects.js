...
const Projects = () => {
  const projectImages = [
    [
      "audiophilesm",
      "Audio shopping e-commerce website",
      "AUDIOPHILE",
      "https://audio-shop.vercel.app/",
    ],
    [
      "kanbansm",
      "Web apllication for users to manage their tasks",
      "KANBAN",
      "https://task-management.up.railway.app/",
    ],
    [
      "proshopsm",
      "Full stack electronics ecommerce website",
      "PRO-SHOP",
      "https://pro-shop.up.railway.app/",
    ],
    [
      "shoppingsm",
      "Brochure website for a shopping app",
      "SHOPPING",
      "https://mihaiwebdev.github.io/Shopping-website/",
    ],
    [
      "githubfindersm",
      "Web application to find github users and see their profile",
      "GITHUB FINDER",
      ...
      <div id="projects" className="footer-cta projects">
        ...
        >
          ...
          <p className="p-font text-white">
            I build websites that are not only beautiful but also scalable,
            secure and easy to navigate using the latest technologies.
          </p>
        </motion.div>

        <motion.svg
          initial={{ right: 400, opacity: 0 }}
        ...
        {projectImages.map((proj, idx) => (
          ...
          >
            <Link to="#" className="project-card">
              <img
                className={`project-img ${proj[0]}`}
                src={require(`../assets/web-design/desktop/${proj[0]}.jpg`)}
                alt=""
              />
